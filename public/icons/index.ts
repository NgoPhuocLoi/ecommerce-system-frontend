...
export const icons = {
  ...
  text: textSvg,
  image: imageSvg,
  heroBanner: heroBannerSvg,
  carousel: carouselSvg,
  video: videoSvg,
  product: productSvg,
  productSet: productSetSvg,
  button: buttonSvg,
  html: htmlSvg,
  spacer: spacerSvg,
  divider: dividerSvg,
